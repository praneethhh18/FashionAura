...
import { casualWearMen, workFormalMen, partyEveningMen, ethnicWearMen, sportsActivewearMen, accessoriesMen } from '@/lib/products';
import type { Product } from '@/types';

const categories = [
    { name: "Casual Wear", products: casualWearMen, tagline: "Effortless style for every day.", href: "/casual-wear/men" },
    { name: "Work & Formal Wear", products: workFormalMen, tagline: "Sharp, sophisticated, and professional.", href: "/work-formal/men" },
    { name: "Party & Evening Wear", products: partyEveningMen, tagline: "Make a statement at every celebration.", href: "/party-evening/men" },
    { name: "Ethnic Wear", products: ethnicWearMen, tagline: "Timeless tradition, modern elegance.", href: "#" },
    { name: "Sports & Activewear", products: sportsActivewearMen, tagline: "Performance and style, combined.", href: "#" },
    { name: "Accessories", products: accessoriesMen, tagline: "The perfect finishing touches.", href: "#" },
]
    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
         <section className="relative h-[60vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="/pages/collections/mencollection.png"
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Discover sharp styles, refined essentials, and modern trends for every occasion.
                 </p>
            </div>
        </section>
