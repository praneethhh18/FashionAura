...
import { workFormalWomen } from '@/lib/products';
...
const categories = [
    "Skirts", "Tops", "Shoes", "Accessories", "Blazers"
];

export default function WomenWorkFormalPage() {
  ...
  const filteredProducts = useMemo(() => {
    if (selectedCategories.length === 0) {
      return workFormalWomen;
    }
    return workFormalWomen.filter(product =>
    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
         <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="/pages/work-formal/wofemale.png"
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Elegant and powerful styles for the modern professional woman.
                 </p>
            </div>
        </section>
        ...
        <div className="px-4 md:px-8 py-12 md:py-16">
            <div className="max-w-7xl mx-auto">
                <h3 className="text-2xl font-bold tracking-wide text-foreground mb-6">
                    {selectedCategories.length > 0 ? `Showing results for: ${selectedCategories.join(', ')}` : 'All Work & Formal Wear'}
                </h3>
