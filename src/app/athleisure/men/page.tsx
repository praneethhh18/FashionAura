...
import { sportsActivewearMen } from '@/lib/products';
...
const categories = ["Track Pants", "Gym T-shirts", "Running Shoes", "Hoodies"];

export default function MenAthleisurePage() {
  ...
  const filteredProducts = useMemo(() => {
    if (selectedCategories.length === 0) {
      return sportsActivewearMen;
    }
    return sportsActivewearMen.filter(product =>
      ...
      <main className="flex-grow">
         <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                ...
                alt="A man during a workout."
                fill
                className="object-cover"
                data-ai-hint="man workout"
                priority
            />
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Performance and style, built for the modern man.
                 </p>
            </div>
        </section>
