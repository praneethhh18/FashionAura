...
import { sportsActivewearWomen } from '@/lib/products';
...
const categories = ["Leggings", "Sports Bras", "Yoga Tops", "Running Shoes"];

export default function WomenAthleisurePage() {
  ...
  const filteredProducts = useMemo(() => {
    if (selectedCategories.length === 0) {
      return sportsActivewearWomen;
    }
    return sportsActivewearWomen.filter(product =>
    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
         <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=1887&auto=format&fit=crop"
                alt="A woman doing yoga outdoors."
                fill
                className="object-cover"
                data-ai-hint="woman yoga outdoors"
                priority
            />
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Find your flow with activewear that blends comfort, function, and style.
                 </p>
            </div>
        </section>
        ...
        <div className="px-4 md:px-8 py-12 md:py-16">
            <div className="max-w-7xl mx-auto">
                <h3 className="text-2xl font-bold tracking-wide text-foreground mb-6">
                  {selectedCategories.length > 0 ? `Showing results for: ${selectedCategories.join(', ')}` : 'All Athleisure'}
                </h3>
