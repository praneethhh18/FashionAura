      ...
      <main className="flex-grow">
        <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                ...
                alt="People in stylish and comfortable athleisure wear."
                fill
                className="object-cover"
                data-ai-hint="athleisure fashion"
                priority
            />
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Where performance meets style. For the gym, the street, and everywhere in between.
                 </p>
            </div>
        </section>
        ...
        <section className="py-16 md:py-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                <Link href="/athleisure/men" className="group relative block overflow-hidden rounded-lg">
                    <Image 
                        src="/pages/athl/at1.png"
                        alt="A man in performance athleisure wear."
                        width={600}
                        height={400}
                        className="object-cover w-full h-auto transition-transform duration-500 group-hover:scale-105"
                        data-ai-hint="man athleisure"
                    />
                    <div className="absolute inset-0 bg-black/40" />
                    <div className="absolute bottom-8 left-8 text-white">
                        <h2 className="text-4xl font-display font-black uppercase tracking-tight">Men's Athleisure</h2>
                 ...
                 <Link href="/athleisure/women" className="group relative block overflow-hidden rounded-lg">
                    <Image 
                        src="/pages/athl/at2.png"
                        alt="A woman in stylish yoga wear."
                        width={600}
                        height={400}
                        className="object-cover w-full h-auto transition-transform duration-500 group-hover:scale-105"
                        data-ai-hint="woman athleisure"
                    />
                    <div className="absolute inset-0 bg-black/40" />
                     <div className="absolute bottom-8 left-8 text-white">
                        <h2 className="text-4xl font-display font-black uppercase tracking-tight">Women's Athleisure</h2>
                        <div className="mt-4 flex items-center gap-2 font-semibold">
                            <span>Shop Now</span>
                            <ArrowRight className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
                        </div>
