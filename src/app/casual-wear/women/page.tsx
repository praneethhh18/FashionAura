...
import { casualWearWomen } from '@/lib/products';
...
const categories = [
    "Dresses", "Tops", "Bottoms", "Shoes", "Jewelry", "Accessories"
];

export default function WomenCasualPage() {
  ...
  const filteredProducts = useMemo(() => {
    if (selectedCategories.length === 0) {
      return casualWearWomen;
    }
    return casualWearWomen.filter(product =>
    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
         <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="https://images.unsplash.com/photo-1496747611176-843222e1e57c?q=80&w=2072&auto=format&fit=crop"
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Chic, comfortable, and ready for anything. Your everyday style, elevated.
                 </p>
            </div>
        </section>
        ...
        <div className="px-4 md:px-8 py-12 md:py-16">
            <div className="max-w-7xl mx-auto">
              <h3 className="text-2xl font-bold tracking-wide text-foreground mb-6">
                {selectedCategories.length > 0 ? `Showing results for: ${selectedCategories.join(', ')}` : 'All Casual Wear'}
              </h3>
