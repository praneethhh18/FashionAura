...
export default function PartyEveningPage() {
  return (
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
        <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="/pages/party-evening/party.png"
                alt="A lively party with people dancing."
                fill
                className="object-cover"
                data-ai-hint="lively party dancing"
                priority
            />
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 ...
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Shine bright with our stunning collection of party and evening wear.
                 </p>
            </div>
        </section>
        ...
        <section className="py-16 md:py-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                <Link href="/party-evening/men" className="group relative block aspect-[4/5] overflow-hidden rounded-lg">
                    <Image 
                        src="/pages/party-evening/menparty.png"
                        alt="A man dressed for a party."
                        fill
                        className="object-cover transition-transform duration-500 group-hover:scale-105"
                        data-ai-hint="man party fashion"
                    />
                    <div className="absolute inset-0 bg-black/40" />
                    <div className="absolute bottom-8 left-8 text-white">
                        <h2 className="text-4xl font-display font-black uppercase tracking-tight">Men's Party</h2>
                 ...
                 <Link href="/party-evening/women" className="group relative block aspect-[4/5] overflow-hidden rounded-lg">
                    <Image 
                        src="/pages/party-evening/womenparty.png"
                        alt="A woman in a glamorous evening dress."
                        fill
                        className="object-cover transition-transform duration-500 group-hover:scale-105"
                        data-ai-hint="woman evening dress"
                    />
                    <div className="absolute inset-0 bg-black/40" />
                     <div className="absolute bottom-8 left-8 text-white">
                        <h2 className="text-4xl font-display font-black uppercase tracking-tight">Women's Party</h2>
                        <div className="mt-4 flex items-center gap-2 font-semibold">
                            <span>Shop Now</span>
                            <ArrowRight className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
                        </div>
