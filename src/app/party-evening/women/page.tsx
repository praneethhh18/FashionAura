...
import { partyEveningWomen } from '@/lib/products';
...
export default function WomenPartyEveningPage() {
    ...
    const filteredProducts = useMemo(() => {
        ...
        return partyEveningWomen;
        }
        return partyEveningWomen.filter(product =>
    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <main className="flex-grow">
         <section className="relative h-[50vh] w-full flex items-center justify-center text-center text-white">
            <Image
                src="/pages/party-evening/woparty.png"
            ...
            <div className="relative z-10 p-8 max-w-4xl">
                 <h1 className="text-5xl md:text-7xl font-display uppercase font-black tracking-tight">
                    Women's Party & Evening
                 </h1>
                 <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
                    Be the life of the party with our glamorous collection.
                 </p>
            </div>
        </section>
